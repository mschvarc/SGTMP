...
@Entity
public class WireModelDto extends BaseEntity {

    @ManyToOne(cascade = CascadeType.ALL)
    private WireSimulatorDto simulator;
    ...
    public WireModelDto(WireSimulatorDto simulator, String modelId, int modelIndex) {
        this.simulator = simulator;
        this.modelId = modelId;
        this.modelIndex = modelIndex;
    }

    public WireSimulatorDto getSimulator() {
        return simulator;
    }

    public void setSimulator(WireSimulatorDto simulator) {
        this.simulator = simulator;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WireModelDto)) return false;
        if (!super.equals(o)) return false;

        WireModelDto wireModel = (WireModelDto) o;
