...
@Entity
public class WireSimulatorDto extends BaseEntity {
    private String simulatorId;
    private boolean virtual = false;

    public WireSimulatorDto() {
    }

    public WireSimulatorDto(String simulatorId) {
        this.simulatorId = simulatorId;
    }

    public WireSimulatorDto(String simulatorId, boolean virtual) {
        this.simulatorId = simulatorId;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WireSimulatorDto)) return false;
        if (!super.equals(o)) return false;

        WireSimulatorDto that = (WireSimulatorDto) o;
