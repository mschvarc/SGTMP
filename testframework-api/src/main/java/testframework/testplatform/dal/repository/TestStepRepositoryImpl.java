...
@Repository
public class TestStepRepositoryImpl implements TestStepRepository {
    ...
    @Autowired
    public TestStepRepositoryImpl(EntityManager entityManager, ConstraintValidatorImpl validator) {
    ...
    public void create(TestStep entity) {
        try {
    ...
    public TestStep getById(long id) {
        return entityManager.find(TestStep.class, id);
    }
