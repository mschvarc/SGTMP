...
@Repository
public class TestTemplateParameterRepositoryImpl implements TestTemplateParameterRepository {
    ...
    @Autowired
    public TestTemplateParameterRepositoryImpl(EntityManager entityManager, ConstraintValidatorImpl validator) {
    ...
    public void create(TestTemplateParameter entity) {
        try {
    ...
    public void update(TestTemplateParameter entity) {
        try {
            validator.validate(entity);
    ...
    public void delete(TestTemplateParameter entity) {
        try {
            validator.validate(entity);
    ...
    public TestTemplateParameter getById(long id) {
        return entityManager.find(TestTemplateParameter.class, id);
    }
