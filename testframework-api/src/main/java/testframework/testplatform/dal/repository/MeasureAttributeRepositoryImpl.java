...
@Repository
public class MeasureAttributeRepositoryImpl implements MeasureAttributeRepository {
    ...
    public void create(MeasureAttribute entity) {
        try {
    ...
    public void update(MeasureAttribute entity) {
        try {
            validator.validate(entity);
    ...
    public void delete(MeasureAttribute entity) {
        try {
            validator.validate(entity);
    ...
    public MeasureAttribute getById(long id) {
        return entityManager.find(MeasureAttribute.class, id);
    }
